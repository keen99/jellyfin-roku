' to use in SG, add this in the xml
'     <script type="text/brightscript" uri="pkg:/source/utils/generalUtils.brs" />


' from https://github.com/BrightcoveOS/Roku-Sample-App/commit/58f9303b735ee6f3cb85dd684d964159f411ca59
'**********************************************************
...
' use .toStr() instead of a utility function?
' '******************************************************
